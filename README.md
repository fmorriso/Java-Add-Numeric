...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/java-add-commas.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/java-add-commas/-/settings/integrations)
